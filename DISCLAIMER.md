...
- **Professional Rules**: Law Society of Ecuador members must comply with applicable professional conduct rules when using AI tools
...
1. Checking the official source (Ecuador Law Reports (ecuadorlaw.org), Ecuador Gazette)
...
This Tool aggregates data from official Ecuador legal databases. However:
...
- Ecuador law changes continuously through new statutes, amendments, and court decisions
...
2. **Official Verification**: Cross-check ALL results with official sources (Ecuador Law Reports (ecuadorlaw.org), Ecuador Gazette)
...
This disclaimer may be updated as the Tool evolves or legal/regulatory requirements change. Check the [GitHub repository](https://github.com/Ansvar-Systems/Ecuador-law-mcp) for the current version.

## Questions?

For questions about this disclaimer or the Tool's limitations, please open an issue on GitHub:
https://github.com/Ansvar-Systems/Ecuador-law-mcp/issues
