...
export function getAbout(db: InstanceType<typeof Database>, context: AboutContext) {
  ...
  return {
    name: 'Ecuadorian Law MCP',
    version: context.version,
    jurisdiction: 'EC',
    description: 'Ecuadorian Law MCP — legislation via Model Context Protocol',
    stats,
    data_sources: [
      {
        name: 'Registro Oficial',
        url: 'https://registroficial.gob.ec',
        authority: 'Registro Oficial del Ecuador',
      },
    ],
    freshness: {
