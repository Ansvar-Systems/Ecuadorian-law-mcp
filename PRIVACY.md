...
This document addresses privacy and confidentiality considerations when using this Tool, with particular attention to professional obligations under Ecuadorian legal professional rules.
...
- Law Society of Ecuador rules require strict confidentiality and data handling controls

**Safe Use Options:**
1. **General Legal Research**: Use Tool for non-client-specific queries
2. **Local npm Package**: Install `@ansvar/ecuador-law-mcp` locally — database queries stay on your machine
...
## Professional Obligations (Ecuador)

### Law Society of Ecuador and Advocates Act

Ecuadorian lawyers (advocates) are bound by strict confidentiality rules under the Advocates Act (Cap 16) and the Law Society of Ecuador Code of Standards of Professional Practice and Ethical Conduct.
...
3. Client matters: Use commercial legal databases (Ecuador Law Reports, LexisNexis East Africa)
...
2. Follow Ecuadorian government information security requirements
...
- **Privacy Questions**: Open issue on [GitHub](https://github.com/Ansvar-Systems/ecuador-law-mcp/issues)
- **Anthropic Privacy**: Contact privacy@anthropic.com
- **LSK Guidance**: Consult Law Society of Ecuador ethics guidance
