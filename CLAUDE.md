# Ecuador Law MCP Server — Developer Guide
...
Ecuador Law MCP server providing Ecuadorian legislation search via Model Context Protocol. Strategy A deployment (Vercel, bundled SQLite DB). Covers data protection, cybercrimes, ICT, companies, consumer protection, and other key Acts.
...
- Ecuador uses "Section N" for Acts and "Article N" for the Constitution
...
1. `scripts/ingest.ts` -> fetches from Ecuador Law -> JSON seed files in `data/seed/`
...
- **Ecuador Law** (ecuadorlaw.org) -- National Council for Law Reporting
- **License:** Government Open Data
- **Languages:** English (en) is the primary legal language; Swahili (sw) for some documents
- **Coverage:** All Acts of Parliament, subsidiary legislation, Constitution of Ecuador 2010, selected case law

## Ecuador-Specific Notes

- Ecuador uses a common law legal system inherited from British colonial administration
- The Constitution of Ecuador 2010 is the supreme law (Article 2)
...
- For the Constitution: "Article N, Constitution of Ecuador 2010"
...
- npm package: `@ansvar/ecuador-law-mcp` with bin entry for stdio
